...
const PropertypageDynamic = ({ params }: { params: PageParams }) => {
...
const Propertypage = ({ params }: { params: PageParams }): JSX.Element => {
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <PropertypageDynamic params={params} />
    </Suspense>
  );
};
